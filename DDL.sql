...
VALUES
('【季節限定】レイニーブルーブーケ', '気品のあるブルーのアジサイを主役にした、存在感のある季節限定ブーケ。心落ち着くインテリアにおすすめです。', 8000, '/images/product15.png', 3, 0),

('【季節限定】サマーサンシャインブーケ', '夏を象徴するひまわりを主役に、ナチュラルな小花やグリーンを合わせた季節限定ブーケ。お部屋に明るい元気を届けます。', 8800, '/images/product13.png', 2, 0),
...
('ミックスローズブーケ', '色とりどりのバラを主役に、グリーンを添えた華やかなブーケ。お祝いや特別な日の贈り物におすすめです。', 12200, '/images/product8.png', 4, 0),

('パステルフラワーブーケ', '優しいピンク、オフホワイトのバラとガーベラを中心に、季節の小花を添えてまとめた花束。ふんわりとしたボリュームで、優しい色合いを添えてくれます。', 8500, '/images/product9.png', 6, 0),

('クラシックローズブーケ', '鮮やかなバラを主役に、可憐なかすみ草を添えたクラシカルな花束。情熱的な愛や心からの祝福を伝えます。', 15900, '/images/product10.png', 1, 0),

('スイートローズブーケ', '淡いピンクのバラだけを束ねた、甘く可憐なブーケ。誕生日や記念日の贈り物に、心ときめく愛らしさを演出します。', 9300, '/images/product11.png', 4, 0),

('レッドチューリップブーケ', '赤いチューリップを贅沢に束ねた、シンプルながら存在感のあるブーケ。春のお祝いや記念日の贈り物にぴったりです。', 7600, '/images/product12.png', 1, 0),

('ビタミンカラーブーケ', '鮮やかなビタミンカラーのバラやガーベラをあしらった、エネルギーあふれるブーケ。お誕生日や励ましの気持ちを伝えるギフトに最適です。', 10800, '/images/product14.png', 2, 0);
